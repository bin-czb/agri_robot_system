...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value='false',
            description=(
                'Publish organized point clouds when true. This is heavier '
                'than the default compact cloud.'),
        ),
        DeclareLaunchArgument(
            'color_width',
            default_value='0',
        ...
        DeclareLaunchArgument(
            ...
            default_value='false',
            description=(
                'Enable Orbbec SDK decimation filter. Keep false when dense '
                'contours are needed.'),
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value='Default',
            description=(
                'G330 depth preset, for example Default, High Accuracy, '
                'High Density, or Medium Density.'),
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value='200hz',
            description=(
                'Accelerometer sample rate. 200hz is the Gemini 330 series '
                'stable default.'),
        ),
        DeclareLaunchArgument(
            'accel_range',
        ...
        DeclareLaunchArgument(
            ...
            default_value='false',
            description=(
                'Publish camera_link -> camera_accel_gyro_optical_frame for '
                'synchronized IMU messages.'),
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value='SW',
            description=(
                'Depth-to-color alignment mode. SW is safest; HW can be '
                'tested if supported.'),
        ),
        DeclareLaunchArgument(
            'publish_orbbec_tf',
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'enable_3d_reconstruction_mode': LaunchConfiguration(
                    'enable_3d_reconstruction_mode'),
                'device_preset': LaunchConfiguration('device_preset'),
                'enable_sync_output_accel_gyro': LaunchConfiguration(
                    'enable_sync_output_accel_gyro'),
